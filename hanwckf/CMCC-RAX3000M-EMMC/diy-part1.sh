...
echo 'src-git passwall_packages https://github.com/xiaorouji/openwrt-passwall2.git;packages' >>feeds.conf.default
echo 'src-git passwall_luci https://github.com/xiaorouji/openwrt-passwall2.git;luci' >>feeds.conf.default
